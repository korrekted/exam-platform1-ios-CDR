...
private extension OSlideImproveView {
    func makeConstraints() {
        ...
        NSLayoutConstraint.activate([
            tag2.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 128.scale),
            tag2.widthAnchor.constraint(equalToConstant: 89.scale),
            tag2.heightAnchor.constraint(equalToConstant: 89.scale),
            tag2.topAnchor.constraint(equalTo: topAnchor, constant: ScreenSize.isIphoneXFamily ? 261.scale : 178.scale)
        ])
        ...
        NSLayoutConstraint.activate([
            tag4.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 241.scale),
            tag4.widthAnchor.constraint(equalToConstant: 78.scale),
            tag4.heightAnchor.constraint(equalToConstant: 78.scale),
            tag4.topAnchor.constraint(equalTo: topAnchor, constant: ScreenSize.isIphoneXFamily ? 309.scale : 226.scale)
        ])
        
        NSLayoutConstraint.activate([
            tag5.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 114.scale),
        ...
        NSLayoutConstraint.activate([
            tag6.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 235.scale),
        ...
        NSLayoutConstraint.activate([
            tag7.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 221.scale),
            tag7.widthAnchor.constraint(equalToConstant: 89.scale),
            tag7.heightAnchor.constraint(equalToConstant: 89.scale),
            tag7.topAnchor.constraint(equalTo: topAnchor, constant: ScreenSize.isIphoneXFamily ? 508.scale : 425.scale)
        ])
